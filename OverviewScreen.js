...
//       )
      ...
      tx.executeSql(
        'INSERT INTO serwis (typ, typ_opcje, mistrz, rodzaj, w_id, serwis_id, opis, status, Timestamp) values (2,' + JSON.stringify(val) + ',' + JSON.stringify(mistrz) +','+ Number.parseInt(nodeDetails.split(';;;')[0]) + ',' + Number.parseInt(nodeDetails.split(';;;')[1]) + ',0,' + JSON.stringify(text) + ',0, datetime("now", "localtime"))'
      )
